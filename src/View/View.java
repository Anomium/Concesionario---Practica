...
public class View extends javax.swing.JFrame {
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        carro.Create(new ProdModel("", txtMarca.getText(), txtColor.getText(), Double.parseDouble(txtPrecio.getText()), Integer.parseInt(txtAno.getText())));
        carro.listarTabla(jTable2);
